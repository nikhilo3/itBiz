...
function Contact_Form() {
  return (
    <>
      <h3 className="text-[#7d4ac7] mb-12 mt-20 font-bold text-2xl">
        Connect With Us
      </h3>
      <div
        className="w-full grid grid-cols-1 md:grid-cols-2 mb-4 px-20 items-center"
        id="contact-us-form"
      >
        <svg
        ...
        <div className="contactcontain ml-[50px]">
          <h1 className="font-semibold mt-1 text-base text-black mb-4 text-nowrap">
            Have any questions? Reach out to us from <br />
            our contact form and we will get back to you shortly.
          </h1>
          <form id="contact_form" className="form" name="contact_form" action="#">
            <p className="username w-full py-2">
              <img
                width="26"
                height="26"
              ...
              <input
                id="name"
                name="conname"
                className="form-input allpadding"
                type="text"
            ...
            <p className="email w-full py-2">
              <img
                width="26"
                height="26"
                src="https://img.icons8.com/metro/26/secured-letter.png"
                alt="secured-letter"
              />
              <input
                id="email"
            ...
            <p className="full-width phone">
              <img
                width="26"
                height="26"
                src="https://img.icons8.com/wired/64/phone.png"
                alt="phone"
              />
              <input
                id="company-name"
            ...
            <p className="full-width detail">
              <img
                width="26"
                height="26"
                src="https://img.icons8.com/ios/50/hand-with-pen.png"
                alt="hand-with-pen"
              />
              <textarea
                minlength="10"
                ...
                cols="30"
                rows="7"
                className="allpadding"
                placeholder="How can we help you? Feel free to get in touch!"
                required
              ></textarea>
            </p>
            <p className="w-full block full-width">
              <input
                type="checkbox"
                id="checkbox"
                name="checkbox"
