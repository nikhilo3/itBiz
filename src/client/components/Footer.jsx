      ...
      <footer class="bg-gray-900">
        <div class="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-24">
          <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              <div class="flex justify-center text-[#2563eb] sm:justify-start">
                <p>ItBiz</p>
              </div>
              ...
              <ul class="flex justify-center gap-6 mt-8 md:gap-8 sm:justify-start">
                <li>
                  <a
                    ...
                    target="_blank"
                    class="text-[#2563eb] transition hover:text-[#2563eb]/75"
                  >
            ...
            <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 md:grid-cols-3">
              ...
              <div class="text-center sm:text-left">
                <p class="text-lg font-medium text-white">We Provide</p>
              ...
              <div class="text-center sm:text-left">
                <p class="text-lg font-medium text-white">Quick Links</p>
